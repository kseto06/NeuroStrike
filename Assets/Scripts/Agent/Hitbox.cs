...
public class Hitbox : MonoBehaviour
{
    ...
    void Start() 
    {
        ...
        hitboxMap = new Dictionary<string, List<string>>
        {
            ...
            { "LowKick", new List<string>{ "RightCalf", "RightKnee", "RightThigh", "RightFoot", "RightToeBase" } },
            { "MidRoundhouseKick", new List<string>{ "RightCalf", "RightKnee", "RightThigh", "RightFoot", "RightToeBase" } },
            { "HighRoundhouseKick", new List<string>{ "RightCalf", "RightKnee", "RightThigh", "RightFoot", "RightToeBase" } },
            { "SpinningHookKick", new List<string>{ "RightFoot", "RightToeBase" } },
            { "SideKick", new List<string>{ "RightCalf", "RightKnee", "RightThigh", "RightFoot", "RightToeBase" } },
